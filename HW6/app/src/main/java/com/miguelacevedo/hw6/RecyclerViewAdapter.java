...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            layout = v.findViewById(R.id.camera_layout_recycler);
        }
    }

    public RecyclerViewAdapter(Camera[] cams) {
        this.cams = cams;
    }
    ...
    public RecyclerViewAdapter.ViewHolder onCreateViewHolder(
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.camera_layout, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        ImageView pic = view.findViewById(R.id.image_container);

        Camera cam = cams[position];
